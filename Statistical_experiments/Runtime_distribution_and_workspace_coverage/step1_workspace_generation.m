% This code is based on the method proposed in the attached PDF.
close all; clear; clc
...
% figure
% robot.plot(zeros(1,11))
% hold on
% scatter3(X_rand_set(1,:),X_rand_set(2,:),X_rand_set(3,:),1,'filled')
...
lc=0.1;    % The cell side length is empirically determined to be about 1/20 of the arm span length
